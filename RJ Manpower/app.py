เพื่อให้โค้ดนี้ทำงานได้ ขั้นตอนแรกที่คุณต้องทำ คือ: ก๊อปปี้ชื่อคอลัมน์จากหน้าเว็บที่มัน Error (หรือจาก Excel ของคุณ) มาใส่ในตัวแปร col_pos, col_area, และ col_man ให้ถูกต้อง 100% ครับ

นี่คือโค้ดที่ออกแบบมาให้คุณ Replace (ลบของเก่าทิ้งแล้ววางใหม่หมด) ได้เลยครับ:
